...
<body>
	...
	<s:form id="saveForm" action="department_update" method="post" namespace="/" theme="simple">
		<!-- 隐藏域，指明修改的是哪个部门 -->
		<s:hidden name="model.did" value="%{model.did}"></s:hidden>
		<table style="font-size:16px" width="600px">
			<tr>
				<td width="30%" align="right">部门名称：</td>
				<td><s:textfield name="model.dname" value="%{model.dname}" /></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><s:textarea rows="5" cols="50" name="model.ddesc" value="%{model.ddesc}"></s:textarea></td>
			</tr>
		</table>
	</s:form>
</body>
